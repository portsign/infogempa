                ...
                <div class="container">
                  ...
                  <div class="container-fluid">
                    ...
                    <div class="navbar-header">
                      ...
                      <a class="navbar-brand" href="#">Cari Gempa</a>
                    </div>
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                      ...
                      <form class="navbar-form navbar-left" role="search">
                        <div class="form-group">
                          <input type="text" class="form-control" placeholder="Cari berdasarkan lokasi">
                        ...
                        <select class="form-control">
                            <option value="">1-2 sr</option>
                            <option value="">2-3 sr</option>
                            <option value="">3-4 sr</option>
                            <option value="">4-5 sr</option>
                            <option value="">5-6 sr</option>
                            <option value="">6-7 sr</option>
                            <option value="">7-8 sr</option>
                            <option value="">8-9 sr</option>
                            <option value="">9-10 sr</option>
                            <option value="">10> sr</option>
                        </select>
                        <select class="form-control">
                            <option value="">tidak berpotensi tsunami</option>
                            <option value="">berpotensi tsunami</option>
                        </select>
                        </div>
